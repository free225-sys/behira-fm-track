...
## DESIGN-052 — Dates et heures Behira

- **Date :** 11 septembre 2026
- **Source :** paquet `BEHIRA_UI_VALIDEE_DESIGN051_2026-09-11_V2` (correctif Groc : plus de `type="time"` visible)
- **Statut :** Porté dans le miroir
- **Fichiers :** `date-input.tsx`, `time-input.tsx`, `select.tsx`, `app/globals.css` (wrap), `AntiZombieSummary` en `Badge`
- **Ne copie pas** `Ge01*` ni les adaptateurs supabase.
