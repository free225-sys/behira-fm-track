...
| --- | --- | --- | --- | --- |
| DESIGN-047 | 2026-08-31 | C11-A : intégration locale de 85b0665 et état score non calculable | Validation des 8 décisions métier | Calcul WILO-01 |
...
## DESIGN-047 — C11-A : checkpoint design intégré sans score inventé

- **Date :** 31 août 2026
- **Auteur :** Dev Lead
- **Statut :** Intégré sur la branche C11 locale, non publié
- **Source :** `design/lot-1-tokens@85b0665`
- **Périmètre :** DEC-015, DESIGN-041 à DESIGN-046, cockpit Santé du bâtiment, notifications et validation client déjà présentes dans le commit source

Le commit design a été intégré sans reconstruire Accueil, les notifications ni le dépôt interne des rapports prestataires. Le layout du cockpit est conservé : échelle 0–100, lollipops, tuiles, ventilation et actions par persona.

Le garde-fou C11 impose toutefois un état honnête tant que les huit décisions métier ne sont pas validées :

- score bâtiment et scores équipements : **non calculables** ;
- scores agents de démonstration : retirés ;
- tendance, facteurs positifs/négatifs et criticité calculée : non affichés ;
- état de source : démonstration, partielle, chargement ou repli ;
- données manquantes : criticité validée, règles/pondérations approuvées, couverture des mesures/maintenances/anomalies et historique d’instantanés ;
- règle de notification « score équipement < 70 » : suspendue tant que le score n’est pas calculable.

DEC-015 n’est pas réécrite. DEC-016 complète son comportement transitoire. Aucun calcul WILO-01, aucune migration distante, aucune préproduction et aucune publication ne sont inclus dans ce lot.
