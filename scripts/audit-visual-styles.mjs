...
const checks = [
  ...
  ['Équipements dans Plus sans étendre les profils terrain', page.includes("key:'equipment'") && page.includes('secondary:true') && page.includes("facility:['workspace','dashboard','registry','equipment','costs','access','manager','report']") && page.includes("administration:['workspace','dashboard','registry','equipment','costs','access']") && !page.includes("electricite:['workspace','report','equipment']")],
  ...
  ['Coûts dans Plus sans étendre les profils terrain', page.includes("key:'costs'") && page.includes("label:'Coûts'") && page.includes("facility:['workspace','dashboard','registry','equipment','costs','access','manager','report']") && page.includes("administration:['workspace','dashboard','registry','equipment','costs','access']") && !page.includes("electricite:['workspace','report','costs']")],
