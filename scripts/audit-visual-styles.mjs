...
const checks = [
  ...
  ['Badges immunisés contre les dispositions de conteneur', finalDeclaration('.badge.badge-critical', 'display') === 'inline-flex' && finalDeclaration('.badge.badge-critical', 'font-style') === 'italic' && finalDeclaration('.badge .badge-icon', 'display') === 'none'],
  ['Mentions italiques sans ruban', finalDeclaration('.badge.badge-critical', 'background') === 'var(--danger-surface)' && finalDeclaration('.badge.badge-critical', 'color') === 'var(--danger-text)' && !css.includes('clip-path:polygon') && css.includes('DESIGN-051')],
  ...
  ['Synthèse anti-dossier-zombie prioritaire dans le dossier central', page.includes('<div className="dossier-continuity"><AntiZombieSummary data={adaptDossierToAntiZombieSummary(anomaly)} variant="detailed" /></div>') && page.indexOf('className="dossier-continuity"') < page.indexOf('className="dossier-tabs"') && css.includes('.dossier-continuity .anti-zombie-summary{margin:0 0 14px;box-shadow:none}')],
  ...
  ['Contexte GE-01 réorganisé', ge01Pilot.includes('type="date"') && ge01Pilot.includes('type="time"') && ge01Pilot.includes('Maintenant') && ge01Pilot.includes('ge-context-markers') && ge01Pilot.includes('ge-agent-chip') && (ge01Pilot.includes('ge-stepper') || countStepper.includes('ge-stepper')) && css.includes('position:sticky') && css.includes('.ge-hours-hint.is-below')],
