...
const checks = [
  ...
  ['Badges immunisés contre les dispositions de conteneur', finalDeclaration('.badge.badge-critical', 'display') === 'inline-flex' && finalDeclaration('.badge.badge-critical', 'border-radius') === '3px 0 0 3px' && finalDeclaration('.badge .badge-icon', 'display') === 'grid'],
  ['Badges ruban sans cran', css.includes('clip-path:polygon(0 0,calc(100% - 8px) 0,100% 50%,calc(100% - 8px) 100%,0 100%)') && finalDeclaration('.badge.badge-critical', 'background') === 'var(--danger-text)' && finalDeclaration('.badge .badge-icon', 'width') === '6px' && finalDeclaration('.badge .badge-icon', 'background') === 'var(--background)'],
