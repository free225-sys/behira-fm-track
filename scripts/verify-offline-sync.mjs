...
const checks = [
  ...
  ["brouillons de ronde persistants", page.includes("saveOfflineDraft<RoundDraft>") && page.includes("loadOfflineDraft<RoundDraft>")],
  ["rondes raccordées à la file réelle", page.includes("offlineSync.enqueueRound") && mutations.includes('"submit_field_round_offline"')],
