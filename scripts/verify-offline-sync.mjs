...
const checks = [
  ...
  ["formulaire déjà synchronisé restauré comme transmis", page.includes("const roundSubmitted = submitted || Boolean(restoredRoundReceipt)") && page.includes("if (submissionLockRef.current) return")],
