...
const checks = [
  ...
  [process.execPath, [npmCli, "run", "verify:anti-zombie"], "Continuité canonique C7"],
  ...
  [process.execPath, [npmCli, "run", "test:db"], "Reconstruction et 13 recettes SQL, dont C8 bout en bout"],
